...
public class SelectSupplier extends javax.swing.JDialog {
    ...
    public void loadSuppliers() {
        try {
            ...
            ResultSet rs1 = MySql.search("SELECT * FROM `supplier` WhERE `supplier`.`status_id` =  '1' ORDER BY `supplier`.`id` ASC");
    ...
    public void searchSupplier(String text) {
        try {
            ...
            ResultSet rs1 = MySql.search("SELECT `supplier`.`id`, `supplier`.`first_name`, `supplier`.`last_name` FROM `supplier` WHERE `supplier`.`status_id` =  '1' AND `supplier`.`first_name` LIKE '" + text + "%'  ORDER BY `supplier`.`id` ASC");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("You can Seach & Select Supplier");
        ...
        jPanel11.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 36, 295, 20));
        ...
        jLabel8.setText("Double Click Supplier to Select It.");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                warn.alertMessage.setText("Please Select Supplier");
                warn.setVisible(true);
            } else {

                String ID = jTable1.getValueAt(r, 0).toString();
                String supplier = jTable1.getValueAt(r, 1).toString();

                ManageGRN.jTextField5.setText(ID);
                ManageGRN.jTextField9.setText(supplier);
                this.dispose();
