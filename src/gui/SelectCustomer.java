...
public class SelectCustomer extends javax.swing.JDialog {
    ...
    public void loadCustomers() {
        try {
            ...
            ResultSet rs1 = MySql.search("SELECT * FROM `customer` WhERE `customer`.`status_id` =  '1' ORDER BY `customer`.`id` ASC");
    ...
    public void searchCustomer(String text) {
        try {
            ...
            ResultSet rs1 = MySql.search("SELECT `customer`.`id`, `customer`.`first_name`, `customer`.`last_name` FROM `customer` WHERE `customer`.`status_id` =  '1' AND `customer`.`first_name` LIKE '" + text + "%'  ORDER BY `customer`.`id` ASC");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("You can Seach & Select Customers");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                warn.alertMessage.setText("Please Select Customer");
                ...
                if (frameAdd.equals("Invoice")) {
                    Invoice.jTextField5.setText(ID);
                    Invoice.jTextField9.setText(name);

                } else if (frameAdd.equals("return")) {
                    SalesReturn.jTextField14.setText(ID);
                    SalesReturn.jTextField15.setText(name);
